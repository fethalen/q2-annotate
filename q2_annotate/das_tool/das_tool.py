...
def _refine_bins_das_tool(
    bins: ContigSequencesDirFmt, contigs: ContigSequencesDirFmt, common_args: list
...
def refine_bins_das_tool(
    bins: ContigSequencesDirFmt,
    contigs: ContigSequencesDirFmt,
    proteins: ProteinsDirectoryFormat | None = None,
    search_engine: str | None = None,
    score_threshold: float | None = None,
    duplicate_penalty: float | None = None,
    megabin_penalty: float | None = None,
    max_iter_post_threshold: int | None = None,
    ...
    kwargs = {
        k: v for k, v in locals().items() if k not in ["bins", "contigs", "proteins"]
    }
    ...
    return _refine_bins_das_tool(
        bins=bins, contigs=contigs, proteins=proteins, common_args=common_args
    )
